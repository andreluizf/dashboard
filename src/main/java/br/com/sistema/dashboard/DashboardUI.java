...
package br.com.sistema.dashboard;

import java.util.HashMap;
import java.util.Iterator;
import java.util.Locale;

import br.com.sistema.dashboard.data.DataProvider;
import br.com.sistema.dashboard.data.Generator;
import br.com.sistema.dashboard.data.MyConverterFactory;
...
public class DashboardUI extends UI {
    ...
    HashMap<String, Class<? extends View>> routes = new HashMap<String, Class<? extends View>>() {
        {
            ...
            put("/cliente", SalesView.class);
            put("/processos", SalesView.class);
            put("/contas", SalesView.class);
    ...
    private void buildMainView() {
        ...
        for (final String view : new String[] { "dashboard", "cliente","processos","contas","sales",
